...
func internetSocket(net, iface string, laddr, raddr sockaddr, deadline time.Time, sotype, proto int, mode string, toAddr func(syscall.Sockaddr) Addr) (fd *netFD, err error) {
	family, ipv6only := favoriteAddrFamily(net, laddr, raddr, mode)
	return socket(net, iface, family, sotype, proto, ipv6only, laddr, raddr, deadline, toAddr)
}
